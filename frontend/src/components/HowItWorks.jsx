...
const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-20 bg-gradient-to-b from-navy-900 to-navy-950 relative overflow-hidden">
      {/* Animated Background */}
      <AnimatedBackground variant="section" intensity="medium" />
      
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 w-32 h-32 bg-gold-500/5 rounded-full blur-xl"></div>
        <div className="absolute bottom-20 right-10 w-40 h-40 bg-blue-500/5 rounded-full blur-xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-gold-500/3 to-blue-500/3 rounded-full blur-3xl"></div>
      </div>
          ...
          {steps.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-gradient-to-br from-navy-800/50 to-navy-900/50 backdrop-blur-sm rounded-2xl p-8 border border-navy-700/50 hover:border-gold-500/30 transition-all duration-300 h-full">
                  {/* Sports Action Image */}
                  <div className="relative mb-8 overflow-hidden rounded-xl">
                    ...
                    {/* Step Number Overlay */}
                    <div className="absolute top-4 left-4 w-12 h-12 bg-gold-500 rounded-full flex items-center justify-center shadow-lg">
                      <span className="text-navy-950 font-bold text-lg">{index + 1}</span>
                    </div>
                  </div>

                  {/* Icon and Title */}
                  <div className="text-center mb-6">
                    <div className="w-16 h-16 mx-auto bg-gradient-to-br from-gold-500 to-gold-600 rounded-xl flex items-center justify-center shadow-lg shadow-gold-500/25 group-hover:shadow-gold-500/40 transition-all duration-300 mb-4">
